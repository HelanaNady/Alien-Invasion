...
{
private:
	enum { MAX_EARTH_ID = 999, MAX_ALIEN_ID = 2999, MAX_ALLIED_ID = 4999};

	static int nextEarthId;
	static int nextAlienId;
	static int nextAlliedId;
...
public:
	...
	static bool cantCreateAlliedUnit(); // Check if the max number of allied units is reached 
